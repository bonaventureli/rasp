/****************************************************************************
** Meta object code from reading C++ file 'b9modelloader.h'
**
...
#error "The header file 'b9modelloader.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_B9ModelLoader_t {
    QByteArrayData data[5];
    char stringdata[50];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_B9ModelLoader_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_B9ModelLoader_t qt_meta_stringdata_B9ModelLoader = {
    {
...
QT_MOC_LITERAL(4, 43, 5)
    ...
    "B9ModelLoader\0PercentCompletedUpdate\0"
    "\0frac\0total\0"
};
...
void B9ModelLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (B9ModelLoader::*_t)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&B9ModelLoader::PercentCompletedUpdate)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject B9ModelLoader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_B9ModelLoader.data,
      qt_meta_data_B9ModelLoader,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_B9ModelLoader.stringdata))
